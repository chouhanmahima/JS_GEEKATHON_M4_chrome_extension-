...
const exportColor = () =>{
    ...
    const a = document.createElement("a"); //generating  <a></a>  tag
    a.href = url;
    a.download = 'Colors.txt';      //download colors from local storage
    document.body.appendChild(a);  //make link clickable: export btn
    a.click();                     //click event on a ele which initiate download process of the file
    document.body.removeChild(a);  //once a download is completes it removes the ele. from the document
